...
const ComparativeAnalysisPage = () => {
    ...
    if (loading) {
        return (_jsx("div", { className: "comparative-analysis-page", children: _jsxs("div", { className: "loading-container", children: [_jsx("div", { className: "loading-spinner" }), _jsx("p", { children: "Loading articles for comparison..." })] }) }));
    }
    return (_jsxs("div", { className: "comparative-analysis-page", children: [_jsx("div", { className: "page-header", children: _jsxs("button", { onClick: () => navigate('/'), className: "back-button", children: [_jsx(FiArrowLeft, {}), " Back to Home"] }) }), _jsx(ComparativeAnalysis, { articles: articles, onAnalysisComplete: handleAnalysisComplete })] }));
};
