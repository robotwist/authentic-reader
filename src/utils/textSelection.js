 ...
 */
export const applyHighlights = (containerElement, annotations) => {
 ...
 */
export const findNodeByPath = (containerElement, path) => {
    if (!path)
        return null;
    ...
    for (const part of parts) {
        ...
        const matchingNodes = childNodes.filter(node => node.nodeName.toLowerCase() === nodeName.toLowerCase());
 ...
 */
export const highlightRange = (range, annotation) => {
 ...
 */
export const removeHighlights = (containerElement) => {
 ...
 */
export const setupHighlightListeners = (containerElement, onHighlightClick) => {
