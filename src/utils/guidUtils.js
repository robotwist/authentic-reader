 ...
 */
export function isGuidObject(guid) {
 ...
 */
export function compareGuids(articleGuid, guidToCompare) {
    try {
        if (!articleGuid || !guidToCompare)
            return false;
 ...
 */
export function extractGuidString(guid) {
    try {
        if (!guid)
            return '';
        // For debugging purposes
 ...
 */
export function createKeyFromGuid(guid, link) {
