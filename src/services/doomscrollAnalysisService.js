 ...
 */
export function analyzeDoomscroll(text) {
    const lowerText = text.toLowerCase();
    let doomscrollScore = 0;
    const doomscrollTopics = [];
 ...
 */
export function analyzeOutrageBait(text) {
    const lowerText = text.toLowerCase();
    let outrageBaitScore = 0;
    const outrageBaitTriggers = [];
 ...
 */
export function analyzeManipulativeContent(text) {
    ...
    const educationalSummary = generateEducationalSummary(doomscrollAnalysis.isDoomscroll, outrageBaitAnalysis.isOutrageBait);
    return {
 ...
 */
function generateEducationalSummary(isDoomscroll, isOutrageBait) {
    let summary = '';
