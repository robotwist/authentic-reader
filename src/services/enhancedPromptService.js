...
class EnhancedPromptService {
     ...
     */
    generateStructuralAnalysisPrompt(article, context) {
...
Provide your analysis in this exact JSON format:
{
  ...
  "analysisQuality": "Assessment of the depth and rigor of this analysis"
     ...
     */
    generateLinguisticAnalysisPrompt(article, context) {
...
Provide analysis in this JSON format:
{
  ...
  "educationalInsights": {
     ...
     */
    generateComprehensiveAnalysisPrompt(article, context) {
...
Provide your comprehensive analysis in this JSON format:
{
  ...
  "analysisQuality": {
     ...
     */
    enhanceResponseWithEducation(response, context) {
