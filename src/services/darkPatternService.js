 ...
 */
import { DarkPatternType } from '../types';
 ...
 */
const analyzeDomStructure = (html) => {
    const detections = [];
 ...
 */
export const detectDarkPatterns = (html) => {
    try {
 ...
 */
export const summarizeDarkPatterns = (detections) => {
    ...
    Object.entries(byType).forEach(([type, patterns]) => {
        ...
        summary += getPatternDescription(type);
        summary += '\n';
 ...
 */
export const analyzeManipulation = async (text) => {
    try {
