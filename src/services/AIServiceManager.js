...
(function (AIServiceProvider) {
    AIServiceProvider["LLAMA"] = "llama";
    AIServiceProvider["LOCAL_ONNX"] = "localOnnx";
    AIServiceProvider["OPENAI"] = "openai";
    AIServiceProvider["ANTHROPIC"] = "anthropic";
})(AIServiceProvider || (AIServiceProvider = {}));
class AIServiceManager {
    constructor() {
        Object.defineProperty(this, "serviceConfigs", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "useLocalFallbacks", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
     ...
     */
    async analyzeLogicalFallacies(text) {
