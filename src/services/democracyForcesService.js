...
class DemocracyForcesService {
    constructor() {
        Object.defineProperty(this, "democracyForces", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "exemplaryArticles", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "trustBuildingFeatures", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
     ...
     */
    initializeTrustBuildingFeatures() {
     ...
     */
    generateMockExemplaryArticles(query, category) {
     ...
     */
    verifySourceTrustworthiness(source) {
        const force = this.democracyForces.find(f => f.name.toLowerCase().includes(source.toLowerCase()) ||
